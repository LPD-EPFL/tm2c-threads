...
__thread unsigned short nodes_contacted[TM2C_MAX_PROCS];
__thread TM2C_RPC_REQ *psc;
__thread int64_t read_value;
__thread unsigned long int* tm2c_rand_seeds;
...
static pthread_once_t tm2c_app_init_once_control = PTHREAD_ONCE_INIT;
void tm2c_app_init_once() {
...
tm2c_app_init(void) 
{
	pthread_once(&tm2c_app_init_once_control, tm2c_app_init_once);
