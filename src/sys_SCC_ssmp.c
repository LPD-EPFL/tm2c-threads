...
dsl_communication()
{
  ...
  while (1) {
      ...
      case PS_LOAD_NONTX:
	{
	  ...
	  /* convert_t c; c.lli = val; */
	  /* PRINT("      LOAD: addr: %10ld   val: %10d   %d", ps_remote->address, c.i[0], c.i[1]); */
      ...
      case PS_STORE_NONTX:
	{
	  ...
	  /* convert_t c; c.lli = ps_remote->write_value; */
	  /* PRINT("     STORE: addr: %10ld   val: %10d   %d", ps_remote->address, c.i[0], c.i[1]); */
	  break;
	}
#endif
      case PS_REMOVE_NODE:
